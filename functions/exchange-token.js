...
export async function handleTokenExchange(context) {
  ...
  try {
    ...
    if (responseData.access_token) {
      return (
        new Response(
          JSON.stringify({ accessToken: responseBody.access_token })
        ),
        {
      ...
      console.error("Access token not found in API response:", responseBody);
